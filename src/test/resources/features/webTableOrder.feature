Feature: Testing entering order


  Scenario: User should be able to place an order that can be seen on web table
  ...
  Scenario Template: User should be able to place an order that can be seen on web table
    Given user is already logged in and on order page
